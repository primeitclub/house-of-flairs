  ...
  return (
    <nav className="flex items-center justify-between px-10 py-6 fixed w-full bg-[#EDFFD3] z-50">
      ...
      <ul className="flex space-x-8 text-gray-800 font-medium">
        <li className="hover:underline hover:text-[#476930] cursor-pointer">Home</li>
        <li className="hover:underline hover:text-[#476930] cursor-pointer">Search Items</li>
        <li className="hover:underline hover:text-[#476930] cursor-pointer">Found report</li>
        <li className="hover:underline hover:text-[#476930] cursor-pointer">About us</li>
