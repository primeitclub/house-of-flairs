...
const ReportLost = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 mt-30 flex items-center justify-center p-6 font-inter">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"
              />
              {errors.itemName && <p className="text-red-600 text-xs mt-1">{errors.itemName}</p>}
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 resize-y"
              ></textarea>
            ...
            <div>
              ...
              {image && (
                <img
                  ...
                  alt="Preview"
                  className="mt-4 w-40 h-40 object-cover rounded-lg border-2 border-red-300 shadow-md"
                />
              )}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-md transition duration-200 disabled:opacity-50"
              >
